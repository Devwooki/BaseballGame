package com.example.baseballgame.validate;
...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        while (!input.equals(answer) || !input.equals("0")) {
            ...
            input = sc.nextLine();
            if (!checkUseful(input)) continue; //자바스크립트 영역
            String result = startGame(input, null);
    ...
    // 456
    public static  String startGame(String input, String answer) { // 123
